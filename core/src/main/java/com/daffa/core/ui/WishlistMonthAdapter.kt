...
import com.daffa.core.databinding.WishlistMonthAdapterBinding
...
class WishlistMonthAdapter : RecyclerView.Adapter<WishlistMonthAdapter.WishViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        val wishlistMonthBinding =
            WishlistMonthAdapterBinding.inflate(
                LayoutInflater.from(parent.context),
                parent,
                false
            )
        return WishViewHolder(wishlistMonthBinding)
    }
    ...
    inner class WishViewHolder(private val binding: WishlistMonthAdapterBinding) :
